...
def timesurface(events, sensor_size, ordering, surface_dimensions=None, tau=5e3, decay="exp", filtering_threshold = 1, drop_proba = None, ts_batch_size = None, first_indice = 0, previous_timestamp = [], device="cpu", dtype='torch.float32'):
