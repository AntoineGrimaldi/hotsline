            ...
            for events, label in loader:
                ...
                if ts_batch_size and len(events)>ts_batch_size:
                    ...
                    for load_nb in range(nb_batch):
                        X, ind_filtered, previous_timestamp = timesurface(events, (ts_size[0], ts_size[1], ts_size[2]), ordering, tau = tau_cla, ts_batch_size = ts_batch_size, drop_proba = drop_proba, load_number = load_nb, previous_timestamp = previous_timestamp, device = 'cpu')
